...
function Intro() {
    ...
    <div class="intro">
        ...
        <br></br>
        <p>and a design thinker with startup experience, business oriented, knowledge of emerging
technologies and interest in sustainability, decentralised technologies and innovation.</p>
        ...
        <p><a href="_blank" target="_blank">--> Download CV</a></p>
    </div>
    )
}
